export default {
  ...
  'heterogeneousStatus.env.checkFailed': 'Connection failed: {{message}}',
  'heterogeneousStatus.env.checkSuccess': 'Connection successful',
  'heterogeneousStatus.env.checkSuccessWithLatency': 'Connection successful ({{latency}} ms)',
  'heterogeneousStatus.env.count': '{{count}} env var',
  'heterogeneousStatus.env.count_other': '{{count}} env vars',
  ...
  'heterogeneousStatus.env.required': 'Required for API billing: {{keys}}',
