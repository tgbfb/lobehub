...
describe('useAuthRequiredModal', () => {
  ...
  it('requires signing in again instead of allowing dismissal', () => {
    translations.current = {
    ...
    expect(modalProps.styles?.close).toEqual({ display: 'none' });
    ...
    expect(modalInstance.update).toHaveBeenCalledWith({ open: true });
  });
});
