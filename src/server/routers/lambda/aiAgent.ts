 ...
 * → topic reverse-lookup is unreliable per Cloud Claude Code integration V3 architecture: shared spawn producer, lh hetero exec CLI, server ingestion via tRPC design decision).
 */
