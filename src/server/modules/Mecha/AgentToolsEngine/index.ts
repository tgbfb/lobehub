...
export const createServerToolsEngine = (
  ...
  // and converge device-access check pipeline + fix activator bypass that exposed owner device list to external bot senders. The enableChecker rules below are defense-in-depth
  ...
  // the second half of the converge device-access check pipeline + fix activator bypass that exposed owner device list to external bot senders wall: an installed plugin or a
...
export const createServerAgentToolsEngine = (
  ...
  return createServerToolsEngine(context, {
    ...
    // gates below (converge device-access check pipeline + fix activator bypass that exposed owner device list to external bot senders).
