 ...
 *
 * (runtime silently continued after tool/assistant message persist failure, causing cascading errors; fixed by fail-fast on FK violations and parent existence preflight)/ large tool results exceeding PG index row limits for the motivation: Drizzle wraps driver errors
