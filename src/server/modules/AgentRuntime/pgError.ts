 ...
 * dashboard needs to classify the failure (see related: large tool results exceeding PG index row limits can also cause silent persist failures; fixed with PG error unwrapping and TOAST tuning).
 *
