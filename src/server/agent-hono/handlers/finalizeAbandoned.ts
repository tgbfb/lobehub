 ...
 * an op has gone silent past the threshold — (tool dispatch silently crashed without finalizing trace snapshots; now snapshot is uploaded on error paths to prevent dangling operations).
 *
