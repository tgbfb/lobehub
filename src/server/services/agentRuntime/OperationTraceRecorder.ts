...
export interface FinalizeParams {
   ...
   * assistant message that triggered the call. (tool dispatch silently crashed without finalizing trace snapshots; now snapshot is uploaded on error paths to prevent dangling operations).
   */
