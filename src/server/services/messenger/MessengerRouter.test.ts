...
describe('MessengerRouter onSubscribedMessage gating', () => {
  ...
  it('responds to a non-mention follow-up while the channel thread is still single-human (single-human thread relaxation: bot responds to non-mention messages in channel )', async () => {
  ...
  it('announces mention-only mode and drops the message when a second human joins (single-human thread relaxation: bot responds to non-mention messages in channel )', async () => {
  ...
  it('only announces mention-only mode once per channel thread (single-human thread relaxation: bot responds to non-mention messages in channel )', async () => {
  ...
  it('responds to a @mention even after multi-human switch (single-human thread relaxation: bot responds to non-mention messages in channel )', async () => {
