...
describe('heterogeneousAgentExecutor DB persistence', () => {
  ...
  describe('final content writes (onComplete)', () => {
    ...
    it('should ignore stale usage on assistant events (from message_start echo)', async () => {
      //-style bug: under partial-messages mode, CC
  ...
  // ────────────────────────────────────────────────────
  // Real trace regression: multi-tool per turn
  // ────────────────────────────────────────────────────
 ...
 describe(' Skill → ToolSearch → MCP repro', () => {
  ...
  describe('CC subagent thread-container', () => {
    ...
    /**
     *: the subagent forwarding guard initially only
 ...
 describe(' Monitor parentId chain', () => {
  ...
  // ────────────────────────────────────────────────────
  // external signal callbacks: Monitor-style reactive reply detection + SignalCallbacks UI block in AssistantGroup (Phase 1): external signal stamping on Monitor-driven follow-up steps
  // ────────────────────────────────────────────────────

  describe('external signal callbacks: Monitor-style reactive reply detection + SignalCallba external signal (metadata.signal)', () => {
    ...
    it('stamps metadata.signal on assistant turns CC opens without user input while a task is active', async () => {
      ...
      // Step 4 post-task summary: tagged with `task-completion` (external signal callbacks: Monitor-style reactive reply detection + SignalCallbacks UI block in AssistantGroup (Phase 1))
