...
export class ConversationControlActionImpl {
   ...
   * implemented and falls through to client local resume — (runAgent dispatcher abstraction: converge client/gateway/hetero entry points through selectRuntimeType, fix implicit client-only paths).
   *
