...
export interface UIChatMessage {
  ...
  sessionId?: string;
  /**
   * External-signal callback blocks (external signal callbacks: Monitor-style reactive reply detection + SignalCallbacks UI block in AssistantGroup (Phase 1)). Set on virtual
  ...
  /**
   * Post-task summary blocks (external signal callbacks: Monitor-style reactive reply detection + SignalCallbacks UI block in AssistantGroup (Phase 1)). Set on virtual assistantGroup
