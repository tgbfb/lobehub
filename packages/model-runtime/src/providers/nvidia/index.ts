...
export const params = {
  ...
  chatCompletion: {
    ...
    // of a raw provider error. (max_completion=0 / input exceeding context window: harness clamped to 0 but still sent requests, failing fast with context_exceeded_pre_flight instead).
