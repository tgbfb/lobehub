...
describe('MessageCollector', () => {
  ...
  describe('findLastNodeInAssistantGroup', () => {
    ...
    it('skips signal-tagged callbacks when locating the group tail', () => {
      // external signal callbacks: Monitor-style reactive reply detection + SignalCallbacks UI block in AssistantGroup (Phase 1): when [signal callback, next tool-using assistant]
  ...
  // ────────────────────────────────────────────────────
  // external signal callbacks: Monitor-style reactive reply detection + SignalCallbacks UI block in AssistantGroup (Phase 1): external signal callback collection
  // ────────────────────────────────────────────────────
  ...
  // ────────────────────────────────────────────────────
  // external signal callbacks: Monitor-style reactive reply detection + SignalCallbacks UI block in AssistantGroup (Phase 1): collectAssistantGroupMessages skips signal-tagged children
  // ────────────────────────────────────────────────────
