export default {
  ...
  'agentOnboardingPromo.description':
    'Set up your agent teams in a quick chat with Hubstr AI. Your existing agents remain unchanged.',
  ...
  'messengerBanner.title': 'Talk to Hubstr AI on your favorite messaging apps',
