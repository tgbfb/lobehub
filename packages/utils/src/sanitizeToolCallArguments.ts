 ...
 * and wasting all accumulated tokens. (invalid tool_call arguments (e.g. '{, ...' from Qwen) persisted in history and poisoned subsequent requests to strict providers like NVIDIA NIM, causing 400 errors).
 *
 * Behavior:
