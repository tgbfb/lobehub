...
export class ToolCallProcessor extends BaseProcessor {
  ...
  private processAssistantMessage(message: any, supportTools: boolean): any {
    ...
    // providers like NVIDIA NIM otherwise 400 on the entire request. (invalid tool_call arguments (e.g. '{, ...' from Qwen) persisted in history and poisoned subsequent requests to strict providers like NVIDIA NIM, causing 400 errors).
