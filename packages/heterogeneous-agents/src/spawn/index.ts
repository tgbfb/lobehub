 ...
 *   - The future `lh hetero exec` CLI — sandbox + terminal flow (Cloud Claude Code integration V3 architecture: shared spawn producer, lh hetero exec CLI, server ingestion via tRPC)
 *
