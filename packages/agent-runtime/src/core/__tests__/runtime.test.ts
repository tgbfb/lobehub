...
describe('AgentRuntime', () => {
  ...
  describe('Batch Tool Execution', () => {
    ...
    //: Gemini 3 thoughtSignature must survive the
  ...
  describe('Multi-Round Batch Tool Execution (multi-round batch tool execution: tool_result messages lost their corresponding )', () => {
    /**
     * This test verifies the fix for multi-round batch tool execution: tool_result messages lost their corresponding tool_use linkage when batches spanned multiple call_llm steps, violating Anthropic API validation:
